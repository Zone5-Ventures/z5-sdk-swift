...
public class ExternalView: APIView {
	...
	@discardableResult
	public func download(_ endpoint: RequestEndpoint, headers: [String: String], queryParams: URLEncodedBody? = nil, with completionHandler: @escaping Completion<URL>) -> PendingRequest? {
